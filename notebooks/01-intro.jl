...
- **Josh Day**, Senior Research Scientist, _Julia Computing_
...
# ╔═╡ 135901ed-9f32-46f6-be40-2fb11f00f35f
include("presentation_utils.jl")
...
# ╔═╡ 9a50a380-ab30-478e-9904-db19221e50d1
half(x::Number) = x / 2

# ╔═╡ 01688d7a-829d-40b4-abef-4f398a35af91
half(x::String) = x[1:round(Int, length(x) / 2)]

# ╔═╡ cc5fc5a6-f328-4653-98d4-9bfc60c9a822
half(1)

# ╔═╡ b2bbe1b3-ac75-4d6b-9765-37e4d207cacb
half("abc123")
