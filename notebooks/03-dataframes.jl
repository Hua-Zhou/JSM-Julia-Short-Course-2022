...
# Package for loading datasets that come bundled with various R packages
using RDatasets
...
# ╔═╡ d610372e-e350-4488-87cd-0ae5c9c6d579
highlight(md"""
The **StatsPlots** package provides a `@df` macro that lets you refer to columns by their `Symbol`. 
""")

# ╔═╡ cfed2940-d038-4047-b25e-4ebdbe4fb4cb
@df mpg density(:Cty, g=:Manufacturer, fillto=0, fillalpha=.3, lw=0)
