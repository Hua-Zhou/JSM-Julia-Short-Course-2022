...
# ╔═╡ 5016a0d4-141c-11ed-1cdb-796b3fd5af51
begin
	using PlutoUI
...
# ╔═╡ f0ae6b49-ac5a-47da-af43-aaab7f3f67ae
md"# Makie"

# ╔═╡ f0b5996a-e275-4bd4-a6b9-bfb1e1bd9137
md"## Build a Plot Piece-by-Piece"

# ╔═╡ 904f415f-604d-43d1-aade-8e4bd169a9e2
volcano = readdlm(Makie.assetpath("volcano.csv"), ',', Float64)

# ╔═╡ e5090ee5-d7e6-4f7b-9b8e-53b58a5f3a7b
highlight(md"#### The basic container in Makie is a `Figure`")

# ╔═╡ 048f9a0f-40fb-4c69-a554-350dd6376246
let
	f = Figure()
	f
end

# ╔═╡ dcacb1a0-4948-43c0-ae2c-b1eb379bff25
highlight(md"""
#### Indexing into a `Figure` creates a subplot.

#### `Axis(sub)` creates an axis for that subplot.
""")

# ╔═╡ bdb9bf1c-4fed-457c-a3e0-9c8c9a2480bc
let
	f = Figure()
	ax = Axis(f[1, 1])
	f
...
# ╔═╡ 24d6de31-0120-41cb-a73c-ec3748020408
highlight(md"""
#### Add something to the subplot:
""")

# ╔═╡ 1787b804-2da3-4a44-a3ba-3a62f9d63a21
let
	f = Figure()
	ax = Axis(f[1, 1])
...
# ╔═╡ 304004a8-e7be-4464-9c52-f798258ec912
let
	f = Figure()
	ax = Axis(f[1, 1])
	co = contourf!(volcano, levels=10)
...
# ╔═╡ 318ffa7e-d8a4-47c2-8011-63671ca19abc
md"## Alternatively: Let Makie do the work"

# ╔═╡ 59cb7997-036f-4d2d-8fb4-02dbb97fc7b3
contourf(volcano)
